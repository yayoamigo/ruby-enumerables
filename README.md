...
In this project, we created enumerables in RuBy
...
```bash
git clone https://github.com/yayoamigo/decode_morse
...
Feel free to check the [issues page](https://github.com/yayoamigo/decode_morsey/issues).
